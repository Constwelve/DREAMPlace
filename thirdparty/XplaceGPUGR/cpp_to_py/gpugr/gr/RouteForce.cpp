...
torch::Tensor RouteForce::getFixedMap() { return router.getFixedMap(); }
...
torch::Tensor RouteForce::calcRouteGradReduce(torch::Tensor mask_map,
                                              torch::Tensor wire_dmd_map_2d,
                                              torch::Tensor via_dmd_map_2d,
                                              torch::Tensor cap_map_2d,
                                              torch::Tensor dist_weights,
    ...
    return router.calcRouteGradReduce(mask_map,
                                      wire_dmd_map_2d,
                                      via_dmd_map_2d,
                                      cap_map_2d,
                                      dist_weights,
